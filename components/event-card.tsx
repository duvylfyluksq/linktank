...
export const EventCard = ({ event }: { event: Event }) => {
    return (
        <Link href={`/events/${event.backlink}`} key={event._id}>
            <div className="border flex border-[#D3D0D0] bg-white mt-6 rounded-2xl w-full py-[1.41rem] px-4 flex-row gap-8">
                ...
                <div className="flex-1 flex flex-col gap-[0.5rem]">
                    ...
                    <p
                        className="pr-10 text-sm md:text-base font-normal text-gray-500 dark:text-gray-400 line-clamp-2"
